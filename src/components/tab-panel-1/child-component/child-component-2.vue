<template>
  <a-collapse class="custom-collapse" v-model:activeKey="activeKey" :bordered="false" :expand-icon-position="'end'"
    ...
    <a-collapse-panel :key="5" header="This is panel header 5" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="6" header="This is panel header 6" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="7" header="This is panel header 7" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="8" header="This is panel header 8" class="custome-collapse-panel">
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid animi autem, distinctio dolorum eligendi
        fugit, id, iusto molestiae officia repellendus reprehenderit soluta! Accusamus ad culpa cumque distinctio qui
        tenetur, unde.
...
const defaultActiveKey = [ 5, 6, 7, 8 ]
