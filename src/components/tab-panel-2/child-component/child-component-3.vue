<template>
  <a-collapse class="custom-collapse"  v-model:activeKey="activeKey" :bordered="false" :expand-icon-position="'end'" @change="onChangePanel($event)">
    <template #expandIcon="{ isActive }">
      <DownOutlined :rotate="isActive ? 0 : 180" />
    </template>
    <a-collapse-panel :key="9" header="This is panel header 9" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="10" header="This is panel header 10" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="11" header="This is panel header 11" class="custome-collapse-panel">
      <p>
    ...
    <a-collapse-panel :key="12" header="This is panel header 12" class="custome-collapse-panel">
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Aliquid animi autem, distinctio dolorum eligendi
        fugit, id, iusto molestiae officia repellendus reprehenderit soluta! Accusamus ad culpa cumque distinctio qui
        tenetur, unde.
...
const defaultActiveKey = [9,10,11,12]
